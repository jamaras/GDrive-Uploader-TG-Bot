...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN = '1641728362:AAEuklNKZQnuAtbOMBTAGY4nX_lssfyyCGg' # Get it from https://t.me/BotFather
    APP_ID = '3938041' # Get it from my.telegram.org/apps
    API_HASH = 'd6b12835de1c7bfe7e877fba8ff417b1' # Get it from my.telegram.org/apps
